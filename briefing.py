...
NTFY_TOPIC     = os.environ.get("NTFY_TOPIC", "")        # your unique ntfy.sh topic name (acts as the "address")
PAGES_URL      = os.environ.get("PAGES_URL", "")         # the GitHub Pages URL where the briefing will be published
# ─────────────────────────────────────────────────────────────────────────────
...
def save_briefing_page(html: str) -> str:
    """Saves the briefing as index.html in the docs/ folder, which GitHub
    Pages publishes automatically. Returns the local path written."""
    out_dir = "docs"
...
def main():
    ...
    saved_path = save_briefing_page(html)
